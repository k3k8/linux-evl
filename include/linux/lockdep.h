...
#define lockdep_assert_held(l)		\
	do { lockdep_assert(LOCKDEP_HARD_DEBUG_RET(l, 1, \
		lockdep_is_held(l) != LOCK_STATE_NOT_HELD)); __assume_ctx_lock(l); } while (0)
...
#define lockdep_assert_held_write(l)	\
	do { lockdep_assert(LOCKDEP_HARD_DEBUG_RET(l, 1,	\
		lockdep_is_held_type(l, 0))); __assume_ctx_lock(l); } while (0)

#define lockdep_assert_held_read(l)	\
	do { lockdep_assert(LOCKDEP_HARD_DEBUG_RET(l, 1,	\
		lockdep_is_held_type(l, 1))); __assume_shared_ctx_lock(l); } while (0)
