...
DEFINE_LOCK_GUARD_1(hybrid_spinlock, hybrid_spinlock_t,
		    hybrid_spin_lock((raw_spinlock_t *)_T->lock),
		    hybrid_spin_unlock((raw_spinlock_t *)_T->lock))

DEFINE_LOCK_GUARD_1(hybrid_spinlock_nested, hybrid_spinlock_t,
		    hybrid_spin_lock_nested((raw_spinlock_t *)_T->lock,
					  SINGLE_DEPTH_NESTING),
		    hybrid_spin_unlock((raw_spinlock_t *)_T->lock))

DEFINE_LOCK_GUARD_1(hybrid_spinlock_irq, hybrid_spinlock_t,
		    hybrid_spin_lock_irq((raw_spinlock_t *)_T->lock),
		    hybrid_spin_unlock_irq((raw_spinlock_t *)_T->lock))

DEFINE_LOCK_GUARD_1(hybrid_spinlock_irqsave, hybrid_spinlock_t,
		    hybrid_spin_lock_irqsave((raw_spinlock_t *)_T->lock,
					   _T->flags),
		    hybrid_spin_unlock_irqrestore((raw_spinlock_t *)_T->lock,
						_T->flags),
		    unsigned long flags)
...
DEFINE_LOCK_GUARD_1(hybrid_spinlock_nested, raw_spinlock_t,
		    raw_spin_lock_nested(_T->lock, SINGLE_DEPTH_NESTING),
		    raw_spin_unlock(_T->lock))
